 ...
 *
 * This code was based on the Android SDK BluetoothSerial Sample
 * $ANDROID_SDK/samples/android-17/BluetoothSerial
 */
public class BluetoothSerialService {
     ...
     */
     ...
     private void connectionFailed() {
         ...
         Bundle bundle = new Bundle();
         bundle.putString(BluetoothSerial.TOAST, "Unable to connect device");
         msg.setData(bundle);
         mHandler.sendMessage(msg);
     }
         ...
         public void run() {
             ...
             while (true) {
                 try {
                     ...
                     mHandler.obtainMessage(BluetoothSerial.MESSAGE_READ, bytes, -1, buffer)
                             .sendToTarget();
                 } catch (IOException e) {
